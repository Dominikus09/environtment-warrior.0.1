  ...
  return (
    <Layout title={"exchange"} cart={reptcart}>
      ...
      <section>
        ...
        <div
          onClick={() => {
            push("/Admin/exchange/complete");
          }}
          className="w-full px-3 py-2 my-4 text-lg font-normal border rounded-md bg-darkgreen text-white cursor-pointer hover:text-greensm hover:bg-white border-greensm flex flex-col items-center shadow-md"
        >
          Complete
        </div>
      </section>
