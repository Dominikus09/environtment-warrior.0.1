  ...
  return (
    <Fragment>
      <div className="h-screen">
        <Head>
          {/* <head> */}
          <title>Plastik Kita</title>
          <meta name="description" content="Generated by create next app" />
          <link rel="icon" href="/assets/LogoPikaNoBG.png" />
        ...
        <main className="">
          ...
          <div className="flex flex-col items- sm:px- w-full min-h-screen">
            {children}
          </div>
          {scrollTop}
        </main>
        <footer className="border-t bg-greensm flex flex-col h-fit justify-end px-10">
          <div className="flex flex-col sm:flex-row py-10 text-white space-y-4 sm:space-y-0  sm:space-x-4">
            <div className="w-full sm:w-4/12 border-r lg:px-3 space-y-2">
              <h2 className="text-white font-bold text-2xl">Plastik Kita</h2>
              <p className="font-light text-gray-200">
                Kami menawarkan solusi ramah lingkungan untuk mengelola sampah
                plastik PET.
              </p>
            </div>
